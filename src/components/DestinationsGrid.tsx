...
export default function DestinationsGrid() {
  return (
    <section className="relative w-full bg-ink px-6 py-24 text-sand sm:px-16">
      <span className="text-xs tracking-[0.4em] text-ochre uppercase">Explore</span>
      ...
      <div className="mt-12 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {NAV_ITEMS.map((item, i) => (
          ...
          >
            ...
            >
              <span className="text-xs text-sand/50">{item.number}</span>
